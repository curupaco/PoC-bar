...
**IMPORTANTE:** O sistema detectará essas chaves automaticamente. Se elas estiverem configuradas na Vercel, o app abrirá sincronizado e funcional em todos os aparelhos sem nenhuma ação adicional.
...
- O app salva automaticamente a cada 3 segundos após qualquer alteração.
