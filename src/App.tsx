...
export const App: React.FC = () => {
  ...
  const renderActiveView = () => {
    switch (activeView) {
      ...
      case 'inventory': return <Inventory products={store.products} stockTransactions={store.stockTransactions} onUpdateStock={store.handleUpdateStock} currentUser={currentUser} activeUnitId={store.validatedActiveUnitId} sales={store.sales} units={store.units} consignedEvents={store.consignedEvents} setConsignedEvents={store.setConsignedEvents} persist={store.persist} />;
