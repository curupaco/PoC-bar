  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <Card variant="glass" padding="md" className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <Button onClick={onShowModal} variant="primary" size="md" className="w-full md:w-auto shrink-0">
          Novo Produto
        </Button>
      </Card>
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <button 
                          ...
                          className={`text-sm ${p.isFavorite ? 'text-amber-500' : 'text-slate-300 dark:text-slate-700'} hover:scale-125 transition-transform`}
                        >
                          ★
                        </button>
                      </div>
