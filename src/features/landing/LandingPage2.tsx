      ...
      <section className="hero-gradient relative pt-16 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-16 scroll-reveal">
            <a href={whatsAppLink} target="_blank" rel="noopener noreferrer" className="cta-glow group bg-[#16a34a] text-white px-12 py-5 rounded-2xl text-lg font-black uppercase tracking-tight transition-all hover:scale-105 active:scale-95 flex items-center gap-3 shadow-xl">
