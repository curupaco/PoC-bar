    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          { label: 'Sincronização', val: 'Ativa', sub: 'v4.2.5 Stable', color: 'text-emerald-500' }
        ].map((stat, i) => (
          <div key={i} className="p-6 border shadow-sm bg-white dark:bg-slate-900 rounded-3xl border-slate-200 dark:border-slate-800">
