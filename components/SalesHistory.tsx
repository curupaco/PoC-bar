              ...
              <tr key={sale.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                ...
                <td className="px-6 py-4">
                  <span className="font-black text-slate-800 dark:text-white uppercase text-xs">
                    ...
                    {sale.customerName && <span className="block text-[9px] text-orange-500 font-bold lowercase tracking-normal">({sale.customerName})</span>}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <div className="text-[10px] text-slate-500 max-w-[200px] truncate">
                    ...
                    }).join(', ') || 'Somente Pagamento'}
                  </div>
                </td>
                <td className="px-6 py-4">
                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold border uppercase ${sale.paymentMethod === 'Pendura' ? 'bg-orange-50 text-orange-600 border-orange-200 dark:bg-orange-900/20 dark:border-orange-800' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700'}`}>
                    {sale.paymentMethod}
                  </span>
                </td>
                <td className="px-6 py-4">
