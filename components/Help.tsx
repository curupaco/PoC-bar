...
const Help: React.FC = () => {
  // Ajuste de tipagem para garantir compatibilidade
    ...
    <div className="max-w-5xl mx-auto space-y-12 pb-24 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[40px] border border-orange-200 dark:border-orange-900/30 shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-sm text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
            <p>• <span className="text-orange-600 font-black">Marcar:</span> Na hora de fechar, selecione <span className="font-bold underline">Pendura</span>.</p>
            <p>• <span className="text-orange-600 font-black">Receber:</span> Vá em <span className="font-black italic">Relatórios > Penduras</span> e clique em <FakeButton>Quitar</FakeButton>.</p>
          </div>
        </section>
      </div>
